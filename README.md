...
6. We need to change the properties of the game in order to connect to the Archipelago Portal 2 APWorld client. Right-click the "Portal 2 Archipelago Mod" game in your Library, and select the "Properties..." menu option.
...
2. Your Portal 2 Archipelago Mod has not got the -netconport launch option set. You can check using the `/check_connection` command in the client. See step 7 of [Installation](#installation) to set the launch option.
